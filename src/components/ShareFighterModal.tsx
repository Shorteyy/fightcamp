    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-panel" style={{ width: 420 }} onClick={(e) => e.stopPropagation()}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
          <div className="heading" style={{ fontSize: 24 }}>INVITE A MEMBER</div>
        ...
        <p style={{ fontSize: 14, color: 'var(--muted-1)', lineHeight: 1.5, marginBottom: 16 }}>
          There's no separate "create account" step — new members create their own login on the sign-up page,
          always joining as a fighter. Once they sign up, they'll appear on the team automatically.
        </p>
        ...
        <p style={{ fontSize: 12, color: 'var(--muted-3)', lineHeight: 1.5, marginTop: 18 }}>
          After they join, open their card on the team to set their goal weight and deadline for them if they haven't yet,
          or promote them to coach.
        </p>
      </div>
    </div>
  );
